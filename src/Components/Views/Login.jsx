...
const Login = () => {
  ...
  return (
    <div className="h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-r from-black via-teal-500 to-emerald-300 to-90% justify-center items-center text-white text-3xl font-bold">
