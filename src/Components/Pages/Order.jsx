    ...
    <div class="flex flex-col min-h-screen bg-slate-100">
      <header className="bg-emerald-500">
        <div className="flex justify-between items-center pl-2">
          <div
            className="flex justify-start items-center pl-2 p-2 cursor-pointer"
      ...
      <main class="flex-1 lg:pl-[200px] lg:pr-[200px] lg:pb-10 lg:pt-10 p-4 overflow-hidden h-fullscreen">
        {activeTab === "products" && (
          <div>
            <button
              onClick={irASeccion}
              className="fixed bottom-0 right-0 pr-4 pb-4  "
            >
            ...
            <section
              ref={seccionRef}
              className="border-2 border-slate-300 mt-4  grid cols-1 rounded-full p-2 bg-white "
            >
              <div className="w-full flex justify-center items-center rounded-xl">
                <h2 className="pl-2 pr-2">
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    className="size-6 text-emerald-5 rounded-xl"
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <div className="flex justify-around pt-4 pb-4">
              ...
              <div
                className="flex justify-center items-center pt-4 pb-4 cursor-pointer"
            ...
            <div className="flex justify-center items-center bg-white border-2 rounded-xl p-4">
              <div className="bg-red-500 text-white rounded-xl p-2 flex justify-center">
                ...
                <button
                  className="pl-2"
                  onClick={() => navigate("/pedido/detalle")}
                >
                  Ver pedido{" "}
                </button>
              </div>
