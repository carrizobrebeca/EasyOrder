        ...
        <div>
            ...
            <div className="gird cols-1 w-[580px] h-[220px] bg-white border-2 rounded-xl p-4 w-full">
              ...
              <div className="pb-4 pt-2">
                <div className="flex justify-between items-center">
                  ...
                  <button className="flex justify-end text-emerald-500 lg:text-xl text-base">
                    Repetir pedido
                  </button>
                </div>
              </div>
              <div>
                <div className="flex justify-between  items-center p-4 border-t-2  border-b-0 border-r-0 border-l-0">
                  <h2 className="bg-emerald-300 text-emerald-700 rounded-full p-2">
                    Entregado
                  </h2>
                  <button
                    className="flex justify-end text-emerald-500 lg:text-xl text-base"
                    onClick={() => navigate("/historial/detalle")}
                  >
                    Ver detalle
                  </button>
                </div>
          ...
          <div className="flex justify-center items-center  pb-4">
            <div className="gird cols-1 w-[580px] h-[220px] bg-white border-2 rounded-xl p-4 w-full">
              ...
              <div>
                <div className="flex justify-between  items-center p-4 border-t-2  border-b-0 border-r-0 border-l-0">
                  <h2 className="bg-red-300 text-red-700 rounded-full p-2">
                    Cancelado
                  </h2>
                  <button className="flex justify-end text-emerald-500 lg:text-xl text-base">
                    Ver detalle
