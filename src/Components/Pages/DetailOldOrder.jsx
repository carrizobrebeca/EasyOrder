        ...
        <div>
          <div className='pb-4 '>
            <div className='flex justify-start  items-center pb-4  border-b-2  border-t-0 border-r-0 border-l-0'>
              <button className='font-bold text-emerald-700 lg:text-3xl text-sm lg:pb-4 pb-2 pl-4' onClick={() => navigate("/historial")}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
              </svg>
              </button>
              <h2 className='font-bold text-emerald-700 lg:text-3xl text-sm lg:pb-4 pb-2 pl-4'>Detalle del pedido</h2>
            ...
            <div className="gird cols-1 w-[580px] h-[350px] bg-white border-2 rounded-xl p-4 w-full">
              ...
              <div className='pb-4 pt-2'>
                <div className='flex justify-between items-center'>
                  ...
                  <h2 className='bg-orange-300 text-orange-700 rounded-full p-2'>Pendiente</h2>
              ...
              <div >
                ...
                <div className='flex justify-center  items-center p-4 border-t-2  border-b-0 border-r-0 border-l-0 border-white'>
                  <div className='flex justify-between  items-center w-full'>
                    <h2 className="lg:text-xl text-base">Impuestos y percepciones: </h2>
                    <h2 className="lg:text-xl text-base">$335764,89</h2>
                  </div>
                </div>
                <div className='flex justify-center  items-center p-4 border-t-2  border-b-0 border-r-0 border-l-0 border-white'>
          ...
          <div className='flex justify-center items-center  pt-4 pb-4 bg-white border-2 rounded-xl'>
            <button className='bg-red-500 rounded-xl text-white  p-4'>Cancelar pedido</button>
          </div>
        </div>
